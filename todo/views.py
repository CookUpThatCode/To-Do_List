...
def signupuser(request):
    if request.method == 'GET':
        # user types in address, or linked to this site
        return render(request, 'todo/signupuser.html', {'form':UserCreationForm()})
    else:
        # else it's a post, filled out POST form and hit submit 
        # create new user
...
def logoutuser(request):
    if request.method == 'POST':  # browsers preload links and will automatically log you out otherwise
        logout(request) 
